...
<div class="row">
  <div class="col-md-3 col-md-offset-2">
    ...
    <a href="http://localhost/Layout/index.php/vistas/page/u">                  
  ...
  <div class="col-md-3 col-md-offset-2">
    <h2>Configuracion</h2>
    <a href="http://localhost/Layout/index.php/vistas/page/configuracion">                   
...
<div class="row">
  <div class="col-xs-3 col-md-offset-2">
    ...
    <h2>Graficas</h2>                  
    <a href="http://localhost/Layout/index.php/vistas/page/g"> 
  ...
  <div class="col-xs-3 col-md-offset-2">
    <h2>Tablas</h2>
    <a href="http://localhost/Layout/index.php/vistas/page/t">                   
